...
export function FloatingWhatsApp() {
  const whatsappUrl = "https://wa.me/552430265648?text=Quero%20ser%20cliente.%20Estou%20vindo%20do%20site%20da%20NZD%20Contabilidade";
  ...
  return (
    ...
    >
      ...
      <span className="absolute right-full mr-4 bg-white text-gray-800 text-sm font-semibold px-4 py-2 rounded-lg shadow-lg opacity-0 group-hover:opacity-100 transition-opacity duration-300 pointer-events-none whitespace-nowrap">
        ...
        <span className="absolute top-1/2 -right-1.5 -translate-y-1/2 border-t-8 border-t-transparent border-b-8 border-b-transparent border-l-8 border-l-white"></span>
      </span>
    </a>
  );
}